...
"""Capture the image manually by pressing keys. This script is mainly for debugging 
the performance of turning of GNM model."""
...
class AsyncImageCapture(AsyncGRPCTask):
    ...
    def __init__(self, robot, params):
        ...
        if not os.path.isdir(os.path.join(os.getcwd(), self.directory)):
            try:
                ...
                print(f"The directory '{self.directory}' has been created.")
            except OSError as e:
                print(f"An error occurred while creating the directory '{self.directory}': {e}")
    ...
    def _handle_result(self, result):
        ...
        # TODO: save the image down the 'img' directory.
        curr_img_name = f"{self.waypoint_idx}.jpg"
        image.save(os.path.join(self.directory, curr_img_name))
        self.waypoint_idx += 1
...
class WasdInterface(object):
    ...
    def __init__(self, robot, params):
        ...
        self._image_task = AsyncImageCapture(robot, params)
        ...
        # TODO: Add a action list.
        self.discrete_action = [ord('w'), ord('s'), ord('a'), ord('d'), ord('q'), ord('e')]
