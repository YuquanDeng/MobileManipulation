...
from utilities.utils import load, save
from omegaconf import DictConfig, OmegaConf


# python3 create_topomap.py  --no-auto-logging
@hydra.main(version_base=None, config_path="../configs", config_name="topomap_config")
def main(cfg):
    ...
    if params['playback']:
        print("Playing back roll out...")

        actions_dir = os.path.join('../../data/habitat/topomap/', params['dir'] + '/action')
        images_dir = os.path.join('../../data/habitat/topomap/', params['dir'] + '/images')
